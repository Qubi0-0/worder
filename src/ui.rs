...
pub fn draw(app: &mut App, frame: &mut Frame) {
    ...
    match app.focused_panel {
        FocusedPanel::TitleBar => app.status_bar.fg_color = FocusedColor::Focused.to_color(),
        FocusedPanel::StatusBar => app.title_bar.fg_color = FocusedColor::Focused.to_color(),
        FocusedPanel::Left => app.left_panel.fg_color = FocusedColor::Focused.to_color(),
